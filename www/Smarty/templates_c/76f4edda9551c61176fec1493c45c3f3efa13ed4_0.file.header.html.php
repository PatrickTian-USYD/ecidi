...
/* Smarty version 3.1.29, created on 2017-08-13 13:08:34
  from "E:\wamp\www\Smarty\templates\header.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_598fded25f8626_66940644',
  'file_dependency' => 
  array (
    '76f4edda9551c61176fec1493c45c3f3efa13ed4' => 
    array (
      0 => 'E:\\wamp\\www\\Smarty\\templates\\header.html',
      1 => 1497182626,
      2 => 'file',
    ),
  ),
...
function content_598fded25f8626_66940644 ($_smarty_tpl) {
?>
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-sidebar-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="style/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
                ...
                <div>
                <h4 class="pull-left font-grey" style="margin-top:18px" >华东院运维管理系统v1.0版本</h4>
                </div>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                            ...
                            <ul class="dropdown-menu">
                                <li class="external">
                                    <h3>
                                        <span class="bold">3 个</span> 告警通知</h3>
...
<!-- BEGIN TODO DROPDOWN -->
                                ...
                                <li>
                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                        <li>
                                            <a href="javascript:;">
                                                <span class="task">
                                                    <span class="desc">运维管理系统发布 v1.2版本 </span>
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle" src="style/assets/layouts/layout/img/touxiang-small.jpg" />
                                <span class="username username-hide-on-mobile"> <?php echo $_smarty_tpl->tpl_vars['FullName']->value;?>
 </span>
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="page_user_profile_1.html">
                                        <i class="icon-user"></i> 个人配置信息 </a>
                                </li>
                                <li>
                                    <a href="app_calendar.html">
                                        <i class="icon-calendar"></i> 我的日常安排 </a>
                                </li>

                                <li class="divider"> </li>
                                <li>
                                    <a href="page_user_lock_1.html">
                                        <i class="icon-lock"></i> 锁定当前屏幕 </a>
                                </li>
                                <li>
                ...
                <form class="search-form search-form-expanded  pull-right" action="page_general_search_2.html" method="GET">
                    <div class="input-group">
