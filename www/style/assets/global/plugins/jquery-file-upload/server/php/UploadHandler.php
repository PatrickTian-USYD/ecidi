...
class UploadHandler
{
    ...
    //include("../../../../../../../../PubApi.php");
    //ITMSWriteLog("Debug","resources->area->add_area","Insert SQL:");
    protected $options;
    ...
    function GetLogFile()
    {
        $DataStr=date('Y-m-d');
        $RootPath=$_SERVER['DOCUMENT_ROOT'];
        $LogFile=$RootPath."/logs/phplog".$DataStr.".txt";
        return $LogFile;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $RootPath=$_SERVER['DOCUMENT_ROOT'];
        $LogFile=$RootPath."/logs/phplog.txt";
        error_log("handle_file_upload->filename:".$file->name, 3, $LogFile);
        //==========================================================================//
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
                    ...
                    error_log("file_path:".$file_path, 3, $LogFile);
                    //==========================================================================//
    ...
    public function post($print_response = true) {
        ...
        $RootPath=$_SERVER['DOCUMENT_ROOT'];
        $LogFile=$RootPath."/logs/phplog.txt";
        error_log("file_name:".$file_name, 3, $LogFile);
        //==========================================================================//
        ...
        if ($upload) {
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    //==========================================================================//
                    error_log("name[index]:".$upload['name'][$index], 3, $LogFile);
                    //==========================================================================//
    ...
    public function delete($print_response = true) {
        ...
        foreach ($file_names as $file_name) {
            ...
            $RootPath=$_SERVER['DOCUMENT_ROOT'];
            $LogFile=$RootPath."/logs/phplog.txt";
            error_log("Delete->file_name:".$file_name, 3, $LogFile);
            //==========================================================================//
