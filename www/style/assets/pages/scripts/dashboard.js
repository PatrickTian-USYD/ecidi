var Dashboard = function() {
    ...
    return {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart .online').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: function (percent) {
                    if (percent >= 98) {
                    	return App.getBrandColor('green');
                      } 
                    else if(percent >= 90) {
                        return App.getBrandColor('yellow');
                      }
                    else
                    	{
                    	return App.getBrandColor('red');
                    	}
                }
                    //App.getBrandColor('yellow')
            });
            
            $('.easy-pie-chart .packetlossrate').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: function (percent) {
            ...
            $('.easy-pie-chart .pingdelay').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: function (percent) {
            ...
            $('.easy-pie-chart .mem').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: function (percent) {
            ...
            $('.easy-pie-chart .health').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: function (percent) {
